...
#
Name     : jdk-commons-digester
Version  : 2.1
Release  : 1
URL      : http://archive.apache.org/dist/commons/digester/source/commons-digester-2.1-src.tar.gz
Source0  : http://archive.apache.org/dist/commons/digester/source/commons-digester-2.1-src.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : Apache-2.0
Requires: jdk-commons-digester-data
...
%package data
Summary: data components for the jdk-commons-digester package.
Group: Data

%description data
data components for the jdk-commons-digester package.


%prep
%setup -q -n commons-digester-2.1-src

python3 /usr/share/java-utils/mvn_alias.py "commons-digester:commons-digester" "org.apache.commons:commons-digester"
python3 /usr/share/java-utils/mvn_file.py :commons-digester commons-digester apache-commons-digester

%build
python3 /usr/share/java-utils/mvn_build.py

%install
xmvn-install  -R .xmvn-reactor -n apache-commons-digester -d %{buildroot}
